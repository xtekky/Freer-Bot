...
class Freer:
    ...
    def decrypt(enc: str, ua: str) -> str:
        return Freer()._decrypt(enc, ua).decode('utf-8') #.replace(r"askkkdsanxc('", '')[:-3]
