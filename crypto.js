...
var CryptoJSAesJson = {
    stringify: function (r) {
        var t = { ct: r.ciphertext.toString(CryptoJS.enc.Base64) };
        return (
            r.iv && (t.iv = r.iv.toString()),
            r.salt && (t.s = r.salt.toString()),
            JSON.stringify(t)
        );
    },
    parse: function (r) {
        ...
        return (
            t.iv && (e.iv = CryptoJS.enc.Hex.parse(t.iv)),
...
module.exports = { CryptoJS, CryptoJSAesJson };